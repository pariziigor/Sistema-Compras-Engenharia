      ...
      <div className="flex gap-4 items-center">
        <div className="flex gap-2 bg-slate-100 p-1 rounded-lg mr-4">
          <button 
            ...
            className={`flex items-center gap-2 px-4 py-2 rounded-md transition-colors text-sm font-medium ${abaAtiva === 'compras' ? 'bg-white shadow-sm text-orange-600' : 'text-slate-500 hover:text-slate-800'}`}
          >
            <Package size={16} /> Compras
          </button>
          <button 
            onClick={() => setAbaAtiva('projetos')}
            className={`flex items-center gap-2 px-4 py-2 rounded-md transition-colors text-sm font-medium ${abaAtiva === 'projetos' ? 'bg-white shadow-sm text-orange-600' : 'text-slate-500 hover:text-slate-800'}`}
          >
        ...
        <button 
          onClick={abrirModal}
          className="flex items-center gap-2 bg-orange-600 text-white px-4 py-2 rounded-lg hover:bg-orange-700 transition-colors shadow-sm text-sm font-medium"
        >
